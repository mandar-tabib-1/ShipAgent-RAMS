...
[        {
        ...
        {
            "targetID": 2, // Vessel/Jet boat (environment 1/2)
            "position": [
                -137.63073752771453,
                -193.54472437864416,
                0
...
#### Vessel
Vessel is an ocean-going research vessel owned by NTNU and was used as a reference target in environment 1.
...
#### Scenario 2
In this scenario Havfruen starts to the east while Vessel starts to the west. The targets perform a crossing maneuver in front of milliAmpere where Havfruen travels behind Vessel relative to milliAmpere. Challenges in this dataset include track merging, merged measurements, track continuation as well as target obscuration.
![Scenario 2 Map](/figs/scenario2_map.jpg)
#### Scenario 3
In scenario 3 Havfruen start to the north of Vessel. Vessel holds a relatively steady course south-west while Havfruen maneuvers around Vessel, passing to the south. Parts of this maneuver takes place in the sensor shadow of Vessel, challenging the ability of the tracking system to both predict and keep alive obscured targets.
![Scenario 3 Map](/figs/scenario3_map.jpg)
#### Scenario 4
Both targets start west of milliAmpere traveling towards it side by side. Close to milliAmpere Vessel performs a maneuver to the north while Havfruen continues on its original course. Challenges in this scenario include target maneuvers and merged radar measurements.
![Scenario 4 Map](/figs/scenario4_map.jpg)
#### Scenario 5
This scenario includes a high-speed overtake from Havfruen in the sensor shadow of Vessel. Both targets start north of milliAmpere to the east with Havfruen behind Vessel. Obscuration and track management are the main challenges in this dataset.
![Scenario 5 Map](/figs/scenario5_map.jpg)
#### Scenario 6
Havfruen starts behind Vessel with both targets situated westward of milliAmpere. Vessel and Havfruen both travel towards milliAmpere with Havfruen directly behind Vessel in its sensor shadow. Closer to milliAmpere Vessel maneuvers northwards revealing Havfruen. Challenges include obscuration and track establishment.
